...
from tests.filters.conftest import DUMMY_ANALYSIS_TARGET, LINE_VARIABLE_PATTERN
...
class TestVariableNotAllowedPatternCheck:
    ...
    def test_variable_check_p(self, file_path: pytest.fixture, success_line: pytest.fixture) -> None:
        ...
        assert VariableNotAllowedPatternCheck().run(line_data, DUMMY_ANALYSIS_TARGET) is False
    ...
    def test_variable_check_n(self, file_path: pytest.fixture, line: str) -> None:
        ...
        assert VariableNotAllowedPatternCheck().run(line_data, DUMMY_ANALYSIS_TARGET) is True
