...
from experiment.src.model_config_preprocess import model_config_preprocess, ML_CONFIG_PATH
...
def train(
    ...
    # random split
    df_train, df_test = train_test_split(df_all, test_size=0.15, random_state=random.randint(1, 0xffffffff))
