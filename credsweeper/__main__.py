...
def get_arguments() -> Namespace:
    ...
    group.add_argument("--export_log_config",
                       nargs="?",
                       help="exporting default logger config to file (default: log_config.json)",
    ...
    parser.add_argument("--config",
                        nargs="?",
                        help="application custom config (default: built-in)",
                        default=None,
                        dest="config_path",
                        metavar="PATH")
    parser.add_argument("--rules",
                        nargs="?",
                        help="path of rule config file (default: built-in)",
                        default=None,
                        dest="rule_path",
                        metavar="PATH")
    parser.add_argument("--log_config",
                        nargs="?",
                        help="path to custom config for logger (default: built-in)",
                        default=None,
                        dest="log_config",
                        metavar="PATH")
