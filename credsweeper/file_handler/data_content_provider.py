...
class DataContentProvider(ContentProvider):
    ...
    def _table_representation(
            ...
            keyword_substrings_check: Callable[[str], bool]):
        """
            ...
            if table_header is None:
                ...
                for cell in tr.find_all(['th', 'td']):
                    ...
                    if td_numbered_line := self._check_multiline_cell(cell):
                        ...
                        td_text_has_keywords = keyword_substrings_check(td_text.lower())
    ...
    def _html_tables_representation(
        ...
        for table in html.find_all('table'):
            if recursive_limit_size < self.__html_lines_size:
                ...
                break
            self._table_representation(table, depth, recursive_limit_size, keyword_substrings_check)

    def represent_as_html(
            self,  #
            depth: int,  #
            recursive_limit_size: int,  #
            keyword_substrings_check: Callable[[str], bool]) -> bool:
        ...
        try:
            ...
            if "</" in text and ">" in text:
                if html := BeautifulSoup(text, features="html.parser"):
                    ...
                    self._html_tables_representation(html, depth, recursive_limit_size >> 1, keyword_substrings_check)
